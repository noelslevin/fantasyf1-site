<h1>2012 FantasyF1 Standings</h1>
...
$num = 0;
$sql="SELECT * FROM view_ff1individualstandingsbyyear WHERE season = '2012'";
...
$num = 0;
$sql="SELECT * FROM view_ff1teamstandingsbyyear WHERE season = '2012'";
foreach ($dbh->query($sql) as $row) {
	$num++;
	$team = $row['team'];
	$total = $row['total'];
